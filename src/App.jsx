...
.sign-field-sig{max-width:100%;max-height:100%;width:auto;height:auto;object-fit:contain;object-position:left center;padding:2px;display:block}
...
function SignatureInput({ height = 140, onChange, value, isInitials = false, fontSize = null }) {
  ...
  useEffect(() => {
    ...
    const cropW = Math.min(500, maxX + pad) - cropX, cropH = Math.min(120, maxY + pad) - cropY;
